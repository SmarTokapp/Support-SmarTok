...
import { formatCurrentMonthYear } from '../utils/dateFormatter.js'
...
export default function TransparencyBoard() {
  ...
  const currentMonth = formatCurrentMonthYear(i18n.language)
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h3 className="text-lg font-semibold text-white">
              {t('transparency.currentMonth')} — <span className="text-smartok-cyan">{currentMonth}</span>
            </h3>
          </div>
        ...
        <div id="breakdown" className="mb-10 scroll-mt-20">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h3 className="text-lg font-semibold text-white">{t('transparency.detailedBreakdown')} — <span className="text-smartok-cyan">{currentMonth}</span></h3>
          </div>
